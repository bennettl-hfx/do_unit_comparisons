---
title: "Dissolved Oxygen Units Comparison - Summary (without flags)"
author: "LB"
date: "2024-08-19"
execute: 
  echo: false
...
- This document removes all observations not flagged as Pass (1). To see this analysis with all observations regardless of QC flag, see do_units_summary_with_flags. 

- Flat Island, 2022-11-19 was removed from this analysis as the entire deployment failed QC testing.
